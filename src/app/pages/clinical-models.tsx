...
export function ClinicalModels() {
  ...
  const models = [
    {
      id: 1,
      name: 'ResNet18 SSL-FL v2.1',
      modality: 'Chest X-Ray',
      status: 'Clinical Approved',
      accuracy: '97.87%',
      trainingRounds: 45,
      lastUpdated: '2024-01-15',
      description: 'Pneumonia detection optimized for federated learning',
      color: 'from-blue-500 to-cyan-600',
      iconColor: 'text-blue-500',
    },
    {
      id: 2,
      name: 'DenseNet121 SSL-FL v3.0',
      modality: 'Brain MRI',
      status: 'Experimental',
      accuracy: '99.02%',
      trainingRounds: 38,
      lastUpdated: '2024-01-20',
      description: 'Brain tumor classification with self-supervised learning',
      color: 'from-purple-500 to-indigo-600',
      iconColor: 'text-purple-500',
    },
    {
      id: 3,
      name: 'EfficientNet-B3 SSL-FL v1.8',
      modality: 'Retinal OCT',
      status: 'Clinical Approved',
      accuracy: '97.50%',
      trainingRounds: 42,
      lastUpdated: '2024-01-12',
      description: 'Retinal disease detection (CNV, DME, Drusen)',
      color: 'from-green-500 to-emerald-600',
      iconColor: 'text-green-500',
    },
    {
      id: 4,
      name: 'MobileNetV2 SSL-FL v2.5',
      modality: 'Skin Lesion',
      status: 'Clinical Approved',
      accuracy: '94.30%',
      trainingRounds: 50,
      lastUpdated: '2024-01-18',
      description: 'Melanoma screening and skin cancer detection',
